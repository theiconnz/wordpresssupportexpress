...
var Mysqldriver = /** @class */ (function () {
    ...
    Mysqldriver.prototype.connectMysql = function () {
        try {
            // @ts-ignore
    ...
    Mysqldriver.prototype.runQuery = function (sqlString, values) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!this.pool)
                    this.connectMysql();
                this.pool.query(sqlString, values, function (error, results, fields) {
                    console.log(results);
                });
                return [2 /*return*/];
            });
    ...
    Mysqldriver.prototype.getPool = function () {
        return this.pool;
    };
    return Mysqldriver;
}());
